...
void lebedev::printGraphs(std::ostream& out, const graphsTree& graphs)
{
  if (graphs.empty())
  {
    out << "\n";
...
void lebedev::vertexes(std::istream& in, std::ostream& out, const graphsTree& graphs)
{
  std::string name;
  in >> name;
...
void lebedev::outBound(std::istream& in, std::ostream& out, const graphsTree& graphs)
{
...
void lebedev::inBound(std::istream& in, std::ostream& out, const graphsTree& graphs)
{
  std::string name, vert;
  in >> name >> vert;
  Graph gr = graphs.at(name);
...
void lebedev::bind(std::istream& in, graphsTree& graphs)
{
...
void lebedev::cut(std::istream& in, graphsTree& graphs)
{
  std::string name, vert1, vert2;
  size_t weight = 0;
  if (!(in >> name >> vert1 >> vert2 >> weight))
...
void lebedev::create(std::istream& in, graphsTree& graphs)
{
  std::string name;
  size_t count = 0;
  if (!(in >> name))
...
void lebedev::merge(std::istream& in, graphsTree& graphs)
{
...
void lebedev::extract(std::istream& in, graphsTree& graphs)
{
...
using cmdMap = lebedev::AVLtree< std::string, std::function< void() > >;
cmdMap lebedev::createCommandsHandler(std::istream& in, std::ostream& out, graphsTree& graphs)
{
  cmdMap commands;
